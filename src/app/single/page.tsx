...
export default function Single(){
  ...
  <div className="container ml-[100px] mx-auto gap-[15px] flex items-center">
    ...
    <span className="text-gray-700 text-sm">Asgaard sofa</span>
        ...
        <div className="flex justify-end mr-[200px] bg-white p-6">
      <div className="w-96">
    ...
    <section className="bg-white w-3/4 mx-auto p-6 shadow-lg rounded-lg mt-10">
  {/* Tabs Section */}
  <div className="flex justify-center mt-0 space-x-10 border-b border-gray-300 pb-4">
